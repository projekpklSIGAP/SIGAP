                ...
                <form action="prosestambah.php" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" maxlength="20" id="nik" name="nik" placeholder="Input NIK RT" autofocus required>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block" name="tambahrt"><i class="nav-icon fas fa-plus">&nbsp Tambahkan</i></button>
                  </div>
                </form>
              </div>
              <!-- /.card -->
